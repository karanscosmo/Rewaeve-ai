      ...
      <div className="fixed bottom-6 right-6 z-[100]">
        <Link href="/dashboard/copilot">
          ...
          >
            ...
            {/* Tooltip */}
            <span className="absolute right-16 bg-surface-container border border-outline-variant/20 text-on-surface px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity shadow-md pointer-events-none">
              ReWeave AI Copilot
            </span>
          </button>
        </Link>
