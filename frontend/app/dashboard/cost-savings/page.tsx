      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between hover-lift">
            ...
            <span className="font-display-hero text-4xl font-extrabold text-primary text-glow">${(ytdSavings/1000000).toFixed(2)}M</span>
            <p className="text-[11px] text-on-surface-variant/80 mt-3 leading-relaxed">
              Consolidated net savings achieved across raw material sourcing and transport offsets.
            </p>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl flex flex-col justify-between hover-lift">
            ...
            <span className="font-display-hero text-4xl font-extrabold text-tertiary">$142,500</span>
            <p className="text-[11px] text-on-surface-variant/80 mt-3 leading-relaxed">
          ...
          <div className="glass-panel p-6 rounded-2xl">
            ...
            <div className="space-y-4 text-xs font-semibold text-on-surface">
              ...
              <div className="flex justify-between border-b border-outline-variant/10 pb-2">
                ...
                <span className="text-secondary">$120,000</span>
              </div>
              <div className="flex justify-between pb-1">
                <span className="text-on-surface-variant">Water reuse ledger</span>
                <span className="text-tertiary">$15,500</span>
              </div>
            </div>
          </div>
        </div>
